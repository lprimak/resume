...
*Please Note:* If your selection process includes online coding assessments such as HackerRank or LeetCode, please refrain from contacting me. These assessments do not accurately represent my expertise in real-world software development and architecture.
...
Linux, MacOS X, UNIX C/C++, Java and Java/Jakarta EE , Docker / Kubernetes, Ansible, Windows, Applications, EJB/Swing / JavaFX/Beans/Rest Services, JNI/JNA, Payara / GlassFish, WebLogic, WebSphere, Oracle, Sybase, Internet Tools (in-depth, kernel level TCP/IP), WWW, HTML5, HTTP, XML / YAML / JSON, DevOps (Jenkins, Ansible, Docker, Kubernetes)
// end::software
...
// tag::memberships[]
[.big]*Memberships and Associations*
